...
<!-- Begin Page Content -->
  <div style="background-image: url('../images/Exterior1.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center; position: relative;">
        <?php
          ...
          <?php
             header('Refresh:1,url=product_category');
             }
          ?> 
                <div class="mt-3 container-fluid py-5 px-2" style="width: 100%; height: 100%; background: rgb(255 115 0 / 72%);">
                    <!-- Page Heading -->
                    <div class="d-flex align-items-center justify-content-center mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="font-family: Alice, serif; font-size: 40px;">Product Category</h1>
                    </div>
                       <div class="d-flex align-items-center justify-content-center mb-4">
         ...
         <table class="table table-striped p-3" style="background: #92b1d0;">
      <?php
  ...
  <tbody class="py-3">
    ...
    <tr>
      ...
      <td data-label="Name" style="font-family: Mona Sans, sans-serif;"><?php echo $prdct_category['name']; ?></td>
    ...
    <div class="trnsctn_modal modal-content" style="background: #c8c8c8;">
      ...
      <div class="modal-body">
        <form class="Category_form mt-5 py-5 px-2 rounded rounded-4" method="post">
             <input type="hidden" name="updateId" value="<?php echo $prdct_category['id'];?>">
  <div class="mb-3">
  ...
  <div class="d-flex justify-content-center mt-5">
    <button type="submit" class="btn" name="update_prdct_category" style="font-family: Mona Sans, sans-serif;">Submit</button>
  </div>
</form>
      </div>
      ...
      <td data-label="Delete"><button class="btn btn-dark" style="padding:10px 30px; font-family: Mona Sans, sans-serif;" onclick="if(!confirm('Do you want to delete <?php echo $prdct_category['name'];?> category?')){
                            return event.preventDefault();                                              
                          }else{
                            deletePrdctcategory(<?php echo $prdct_category['id']?>);                                              
    ...
    ?>      
     <tr>
      <th scope="col" colspan="8" class="fs-2" style="text-align: center; font-family: Alice, serif; font-size: 40px;">Sorry! no product category here</th>
    </tr>
    <?php
      }
    ?>
      ...
      <form class="d-none" id="Deletedprdctctgryform" method="post">
               <input type="hidden" id="DeletedprdctctgryID" name="DeletedprdctctgryID">
             </form>
       </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="d-flex justify-content-center mt-5">
    <button type="submit" class="btn" name="add_prduct_category">Submit</button>
  </div>
</form>
      </div>
      <div class="modal-footer">
