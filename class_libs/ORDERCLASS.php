...
public function user_index($m){
 ...
 public function getProducts($t){
      $connection = $this->connection;
           ...
           $view_products_query = "SELECT *,product.name,product.product_id,product.image FROM order_list JOIN(product) ON order_list.product_id=product.product_id WHERE order_list.order_id='$t'";
